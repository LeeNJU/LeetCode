...
#include<algorithm>
#include<numeric>
//题目描述:给定一个数组ratings，表示每个小孩的值，给每个小孩发糖果，要求ratings值大的必须要比相邻的ratings
//         值小的糖果数要多,求最少需要多少个糖果
//解法描述:扫描两遍，先从左往右扫描，把位于波谷位置的值设为1，依次加1，一直加到波峰，再到波谷时又是1，再依次
//         加到波峰,再从右往左扫描，波谷时设为1，依次加1到波峰，此时的波峰因为第一遍扫描已经有值了，必须取
//         二者的最大值
